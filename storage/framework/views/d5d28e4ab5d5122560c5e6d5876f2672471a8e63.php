    ...
    <div id="app">
        ...
        <div class="flex flex-wrap justify-center">
            <a v-for="item in items" href="#" class="m-6 block max-w-md p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white" :key="item.id"><?php echo e(item.title); ?></h5>
                <p class="font-normal text-gray-700 dark:text-gray-400"><?php echo e(item.body); ?></p>
            </a>
        </div>
    </div>
...
<?php /**PATH J:\CLE usb\mon-premier-projet\resources\views/produits.blade.php ENDPATH**/ ?>